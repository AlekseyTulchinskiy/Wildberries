...
func ServerStart(c *cache.Cache) error {
...
func HundlerGet(w http.ResponseWriter, r *http.Request, c *cache.Cache) {
...
func getOrder(w http.ResponseWriter, r *http.Request, c *cache.Cache) {
